...
// TODO(auth): This is a demo bridge to map session tokens onto UUID-shaped IDs.
// Replace with first-class identity (Supabase Auth, Clerk, Auth0, or magic-link flow)
// where auth.uid() maps directly to memberships.user_id.
